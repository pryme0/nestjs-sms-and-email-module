...
/**
 * @var name ;  variable name of the field you want to inject
 * @var conent; value of the filed you want to inject
 */

export interface MailChimpTemplateEmailInterface
  extends BaseMailchimpInterface {
  message: MailChimpMessagePayload | MailChimpMessagePayload[];
